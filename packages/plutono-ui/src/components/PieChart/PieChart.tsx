        ...
        getDisplayValues: () => {
          ...
          if (valuesToShow.includes(PieChartLegendValues.Value)) {
            displayValues.push({
              ...
              text: formattedValueToString(value),
              title: valuesToShow.length > 1 ? 'Value' : undefined,
            });
          }
...
function getGradientColorFrom(color: string, theme: PlutonoTheme) {
...
function getGradientColorTo(color: string, theme: PlutonoTheme) {
  return tinycolor(color)
